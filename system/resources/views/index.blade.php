                            ...
                            <div id="brand" class="brand-bg">
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 margintop">
                                        <div class="brand-box">
                                            <i><img src="{{url('public')}}/icon/brandhermes.png" />
                                            </i>
                                            <h4>HERMES</h4>

                                        </div>
                                        <a class="buynow" href="{{url('kategori')}}/">Open</a>
                                    </div>
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 margintop">
                                        <div class="brand-box">
                                            <i><img src="{{url('public')}}/icon/brandzara.png" /></i>
                                            <h4>ZARA</h4>
                                        </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                        <div class="brand-box">
                                            <i><img src="{{url('public')}}/icon/brandgucci.png" /></i>
                                            <h4>GUCCI</h4>
                                        </div>
                                        <a class="buynow" href="#">Open</a>
                                    </div>
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                        <div class="brand-box">
                                            <i><img src="{{url('public')}}/icon/brandck.png" /></i>
                                            <h4>CALVIN & KLEIN</h4>
                                        </div>
                                        <a class="buynow" href="#">Open</a>
                                    </div>
                        ...
                        <div class="col-md-12">
                            <div id="tas" class="tas-bg">
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 margintop">
                                        <div class="tas-box">
                                            <i><img src="{{url('public')}}/icon/tasck.png" />
                                            </i>
                                            <h4>Rp. 244.900</h4>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 margintop">
                                        <div class="tas-box">
                                            <i><img src="{{url('public')}}/icon/taszara.png" /></i>
                                            <h4>Rp. 275.000</h4>
                                        </div>
                                        <a class="buynow" href="#">Masukkan Keranjang</a>
                                    </div>
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                        <div class="tas-box">
                                            <i><img src="{{url('public')}}/icon/tashermes.png" /></i>
                                            <h4>Rp. 315.000</h4>
                                        </div>
                                        <a class="buynow" href="#">Masukkan Keranjang</a>
                                    </div>
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                        <div class="tas-box">
                                            <i><img src="{{url('public')}}/icon/tasgucci.png" /></i>
                                            <h4>Rp. 260.000</h4>
                                        </div>
                                        <a class="buynow" href="#">Masukkan Keranjang</a>
                                    </div>
